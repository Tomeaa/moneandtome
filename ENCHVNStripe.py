...
subscriber = 843841687,1776567227,1133597877
	...
	try:
		with open("combo.txt", 'r') as file:
			...
			for cc in lino:
				...
				bot.edit_message_text(chat_id=message.chat.id, message_id=ko, text='''Eyad CHK Is Luanching ➜ @FJ0FF''', reply_markup=mes)
